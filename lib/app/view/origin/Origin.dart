...
class _OriginState extends State<Origin> {
    ...
    Widget build(BuildContext context) {
        return Scaffold(
            ...
            body: new Container(
                child: new Center(
                    child: new ImagePickerOrigin(title: 'Image Picker Example'),
                ),
            ),
        );
    }
...
class ImagePickerOrigin extends StatefulWidget {
    ImagePickerOrigin({Key key, this.title}) : super(key: key);
...
class _ImagePickerState extends State<ImagePickerOrigin> {
